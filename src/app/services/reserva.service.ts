...
export class ReservaService {
  ...
  url2: string = "http://amdigital.tech/AMdigital_MercadoBodegas/public/api/reservas/"
  url3: string = "http://amdigital.tech/AMdigital_MercadoBodegas/public/api/reservas/insertarReserva"
